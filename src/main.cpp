...
int history_idx;
int history_count;
float silence_percentile = 0.10f;
float noise_percentile = 0.30f;
float baseline_silence = 0.0f;
float baseline_noise = 0.0f;
float detection_sigma_multiplier = 4.0f;
float reset_sigma_multiplier = 2.0f;
unsigned long last_trigger_ms = 0;
unsigned long refractory_ms = 250UL;
int consecutive_required = 2;
int consecutive_count = 0;
float prev_rms = 0.0f;
float rms_derivative = 0.0f;
float derivative_alpha = 0.3f;
float min_derivative_threshold = 0.01f;
